...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="push_green")
    parser.add_argument("--log-dir", type=str, default="./logs/push_green/")
    parser.add_argument("--model-dir", type=str, default="./models/push_green/")
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--harmony", type=bool, default=True)

    # TODO
    """WARNING:absl:Failed to converge after 99 steps: err_norm=0.0196803"""
    # robodesk1m, ratio=1 / 8, gradient_step=125k
    parser.add_argument("--running-steps", type=int, default=1_000_000)  # 1m
    parser.add_argument("--eval-interval", type=int, default=20_000)  # 50 logs
    parser.add_argument("--replay-ratio", type=int, default=0.125)

    # parallels & benchmark
    parser.add_argument('--buffer_size', type=int, default=1_000_000)  # 4e6
...
if __name__ == '__main__':
    ...
    parser = parse_args()
    configs_dict = get_configs(file_dir="config/robodesk.yaml")
